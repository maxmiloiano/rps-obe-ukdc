...
<ul class="nav nav-tabs mb-3">
    <li class="nav-item">
        <a class="nav-link" href="{{ route('kurikulum.pl.index') }}">
            Profil Lulusan (PL)
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link active" href="{{ route('kurikulum.cpl.index') }}">
            CPL Prodi
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="{{ route('kurikulum.indikator.index') }}">
            Indikator CPL</a>
    </li>
    <li class="nav-item">
...
<div class="row align-items-center mb-3">
    ...
    <div class="col-md-3">
        <label class="d-flex align-items-center gap-2 mb-0">
            Show
            <select id="cplLength" class="form-select form-select-sm w-auto">
    ...
    <div class="col-md-6 text-center">
        <button class="btn btn-success me-2"
            ...
            data-bs-target="#addCPL">
            <i class="bi bi-plus-circle"></i> Add
        </button>

        <button class="btn btn-info"
            data-bs-toggle="modal"
            data-bs-target="#importCPL">
...
<form method="POST"
      action="{{ route('kurikulum.cpl.destroy', $item->id) }}"
      class="modal-content">
...
{{-- ================= MODAL ADD CPL ================= --}}
<div class="modal fade" id="addCPL">
<div class="modal-dialog">
<form method="POST"
      action="{{ route('kurikulum.cpl.store') }}"
      class="modal-content">
@csrf

<div class="modal-header">
    <h5 class="modal-title">Tambah CPL Prodi</h5>
...
{{-- ================= MODAL IMPORT CPL ================= --}}
<div class="modal fade" id="importCPL">
<div class="modal-dialog">
<form method="POST"
      action="{{ route('kurikulum.cpl.import') }}"
      enctype="multipart/form-data"
      class="modal-content">
@csrf

<div class="modal-header">
    <h5 class="modal-title">Import CPL Prodi</h5>
    <button type="button"
            class="btn-close"
            data-bs-dismiss="modal"></button>
</div>
...
<div class="modal-footer">
    <a href="{{ route('kurikulum.cpl.template') }}"
...
$(document).ready(function () {
    ...
    $('#cplLength').on('change', function () {
        table.page.len($(this).val()).draw();
    });

    $('#cplSearch').on('keyup', function () {
